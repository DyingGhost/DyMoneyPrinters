...
function ENT:Draw()
	...
	local text = self.Name or DarkRP.getPhrase("money_printer")
...
draw.DrawText((self.Icon or "£ ")..self:GetStoredMoney(), "blurview_big",-0,-100/2 + 125/5, Color(255,255,255,255),TEXT_ALIGN_CENTER)
	cam.End3D2D()
